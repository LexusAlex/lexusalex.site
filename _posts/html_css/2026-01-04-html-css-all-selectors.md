...
|------------------|:--------------------------------------------------:|:----------------------------------------------------------------------:|:------------------------------------:|---------------------------------------|------------|:-------------:|----------------------------------------------------------------------------------------|
| `*`              |               Универсальный селектор               |                   Попадают все элементы на странице                    |      `<body><div></div></body>`      | [1](#universal-1)                     | `baseline` |     0,0,0     | Медленно - Сопоставляется с абсолютно каждым элементом                                 |
| `div`            |                   Селектор тега                    |                     Все элементы `div` на странице                     |       `<div></div><div></div>`       | [1](#tag-1)                           | `baseline` |     0,0,1     | Быстро   - Быстро не не так эффективно как id и классы                                 |
| `#header`        |                  Селектор по `id`                  |                        Элемент с указанным `id`                        |      `<div id="header"></div>`       | [1](#id-1)                            | `baseline` |     1,0,0     | Очень быстро - Обращение идет сразу к элементу                                         |
| `.title`         |                 Селектор по классу                 |                    Все элементы с указанным классом                    |    `<span class='title'></span>`     | [1](#class-1)                         | `baseline` |     0,1,0     | Очень быстро - Браузеры индексируют классы при парсинге DOM                            |
...
| `[lang]`         |                Элементы с атрибутом                |                     Все элементы где есть атрибут                      |       `<div lang="ru"></div>`        | [1](#attr-1)                          | `baselne`  |     0,1,0     | Медленно - Атрибутные селекторы требуют полного обхода элементов                       |
| `[lang="en"]`    |           Элементы со значением атрибута           |         Все элементы, где у атрибута есть конкретное значение          |       `<div lang="en"></div>`        | [1](#attr-2)                          | `baselne`  |     0,1,0     | Медленно - Сравниваются строки                                                         |
| `[class*="red"]` |          Значение атрибута как подстрока           |         Все элементы, где есть значение атрибута в любом месте         | `<div class="greenredyellow"></div>` | [1](#attr-3)                          | `baselne`  |     0,1,0     | Очень медленно - Производится анализ подстроки (Строка проверяется полностью)          |
| `[class~="red"]` |      Значение атрибута есть в списке значений      |     Все элементы, где значение есть в списке разделенным пробелами     | `<div class="red blue black"></div>` | [1](#attr-4)                          | `baselne`  |     0,1,0     | Средне - Строка разбивается на массив. Поиск по массиву с точным совпадением.          |
| `[class^="red-"]` |      Значение атрибута начинается со значения      |       Все элементы, где значение атрибута начинается со значения       |   `<div class="red-color"></div>`    | [1](#attr-5)                          | `baselne`  |     0,1,0     | Медленно - Производится анализ подстроки (Только в начале или конце).                  |
| `[class$="red"]` |    Значение атрибута заканчивается со значения     |     Все элементы, где значение атрибута заканчивается со значения      |   `<div class="color-red"></div>`    | [1](#attr-6)                          | `baselne`  |     0,1,0     | Медленно - Производится анализ подстроки (Только в начале или конце).                  |
...
| `p span`         |                 Селектор потомков                  |   Выбирает элементы ,которые являются потомками указанного элемента    |        `<p><span></span></p>`        | [1](#descendant-1) [2](#descendant-2) | `baselne`  |     0,0,2     | Медленно - Необходимо проверять большое кол-во узлов без ограничения по вложенности.   |
| `p > span`       |                 Дочерний селектор                  |   Выбирает элементы которые прямые или дочерние укаазнного элемента    |        `<p><span></span></p>`        | [1](#child-1)                         | `baselne`  |     0,0,2     | Средне - Сопоставление происходит не по всему документу, а в ограниченной вложенности. |
...
| `h1, h2, h3`     |               Группировка селекторов               |             Групирует селекторы для одних и тех же правил              |         `<h1></h1><h2></h2>`         | [1](#group-1)                         | `baselne`  |     0,0,1     |                                                                                        |
| `:link`          |                Непосещенные ссылки                 |        Применяться для ссылок, которые пользователь не посещал         |                                      |                                       |            |               |                                                                                        |
| `:visited`       |          Посещенные ссылки пользователем           |                                                                        |                                      |                                       |            |     0,1,1     |                                                                                        |
| `:hover`         |                Наведение на элемент                |           Применятся при наведении курсора на любой элемент            |                                      |                                       |            |     0,1,1     |                                                                                        |
| `:active`        |             В момент нажатия на элемен             | Применяется к элементам взаимодествие с которыми идет в текущий момент |                                      |                                       |            |               |                                                                                        |
|                  |                                                    |                                                                        |                                      |                                       |            |               |                                                                                        |
|                  |                                                    |                                                                        |                                      |                                       |            |               |                                                                                        |
|                  |                                                    |                                                                        |                                      |                                       |            |               |                                                                                        |
|                  |                                                    |                                                                        |                                      |                                       |            |               |                                                                                        |
...
|                  |                                                    |                                                                        |                                      |                                       |            |               |                                                                                        |
|                  |                                                    |                                                                        |                                      |                                       |            |               |                                                                                        |
| `:not()`         |                                                    |                                                                        |                                      |                                       |            |               | Очень медленно - требует дополнительной проверки                                       |
...
![Группировка селекторов](/assets/img/posts/css/selectors/all/s20.png){: .shadow }
