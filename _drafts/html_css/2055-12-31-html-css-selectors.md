...
## Вложенный селектор (E E)

Вложенный селектор или селектор потомков управляет вложенными элементами друг в друга

### Пример 1. Базовый пример вложеного селектора
