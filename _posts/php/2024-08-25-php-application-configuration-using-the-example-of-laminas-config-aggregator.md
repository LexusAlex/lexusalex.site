...
> Главное чтобы было удобно нам всем этим пользоваться ведь гибкость - это когда нет зависимости между моделей данных, бизнес логикой, поведением и местом хранения данных.
{: .prompt-info }
