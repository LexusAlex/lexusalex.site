...
8. [attribute|=value]: Выбирает все элементы с указанным атрибутом, начинающимся с указанного значения, за которым сразу следует дефис (-).
9. [attribute^=value]: Выбирает все элементы с указанным атрибутом, значение которого начинается с указанного значения.
10. [attribute$=value]: Выбирает все элементы с указанным атрибутом, значение которого заканчивается указанным значением.
11. [attribute*=value]: Выбирает все элементы с указанным атрибутом, значение которого содержит указанное значение где-либо.
