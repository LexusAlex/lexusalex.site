...
Символьный класс - это комбинация символов в квадратных скобках.
...
Но как найти просто **телефон**. Как сказать что символьный класс может быть, а может и не быть. Для этого существует квантификатор `?`.
...
В итоге нашли все возможные варианты.
