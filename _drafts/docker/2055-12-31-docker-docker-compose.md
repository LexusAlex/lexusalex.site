...
Пока docker-compose нужно обновлять вручную.
...
В текущих реалиях `docker` может работать следующим образом в виде иерархии.
...
Так же образ можно скачать по его идентификатору

````shell
docker pull ubuntu@sha256:278628f08d4979fb9af9ead44277dbc9c92c2465922310916ad0c46ec9999295
````

> По умолчанию образы качаются с docker hub, но это может быть любое другое хранилище
{: .prompt-info }

### docker images или docker image ls или docker image list

Команда выводит списков всех созданных образов в системе в таблице
